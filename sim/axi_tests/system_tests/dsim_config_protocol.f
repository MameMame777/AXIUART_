# DSIM Configuration File for UART Protocol Validation Test
# Complete UART protocol testing with frame transmission and response validation
...
# Test files
uart_protocol_validation_test.sv

# Top-level module
-top uart_protocol_validation_test
